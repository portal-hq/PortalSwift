...
public protocol PortalMpcProtocol {
  ...
  func setGDriveConfiguration(clientId: String, useAppDataFolderForBackup: Bool, folderName: String) throws
...
public class PortalMpc: PortalMpcProtocol {
  ...
  public func setGDriveConfiguration(clientId: String, useAppDataFolderForBackup: Bool, folderName: String) throws {
    ...
    storage.useAppDataFolderForBackup = useAppDataFolderForBackup
