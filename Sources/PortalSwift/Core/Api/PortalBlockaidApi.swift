...
public class PortalBlockaidApi: PortalBlockaidApiProtocol {
  ...
  public init(
    ...
    PortalCredentialSupport.installUnauthorizedHook(on: self.requests, for: credentials, context: "PortalBlockaidApi")
  }
  ...
  public func scanEVMTx(request: BlockaidScanEVMRequest) async throws -> BlockaidScanEVMResponse {
    ...
    do {
      return try await post(url, andPayload: request, mappingInResponse: BlockaidScanEVMResponse.self)
    } catch {
  ...
  public func scanSolanaTx(request: BlockaidScanSolanaRequest) async throws -> BlockaidScanSolanaResponse {
    ...
    do {
      return try await post(url, andPayload: request, mappingInResponse: BlockaidScanSolanaResponse.self)
    } catch {
  ...
  public func scanAddress(request: BlockaidScanAddressRequest) async throws -> BlockaidScanAddressResponse {
    ...
    do {
      return try await post(url, andPayload: request, mappingInResponse: BlockaidScanAddressResponse.self)
    } catch {
  ...
  public func scanTokens(request: BlockaidScanTokensRequest) async throws -> BlockaidScanTokensResponse {
    ...
    do {
      return try await post(url, andPayload: request, mappingInResponse: BlockaidScanTokensResponse.self)
    } catch {
  ...
  public func scanURL(request: BlockaidScanURLRequest) async throws -> BlockaidScanURLResponse {
    ...
    do {
      return try await post(url, andPayload: request, mappingInResponse: BlockaidScanURLResponse.self)
    } catch {
