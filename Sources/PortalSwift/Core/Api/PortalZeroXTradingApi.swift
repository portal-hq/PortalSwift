...
/// Protocol for 0x Trading API interactions.
...
/// API class specifically for 0x Trading integration functionality.
public class PortalZeroXTradingApi: PortalZeroXTradingApiProtocol {
  ...
  public func getSources(chainId: String, zeroXApiKey: String? = nil) async throws -> ZeroXSourcesResponse {
    ...
    do {
      ...
      return try await post(url, andPayload: body, mappingInResponse: ZeroXSourcesResponse.self)
    } catch {
  ...
  public func getQuote(request: ZeroXQuoteRequest, zeroXApiKey: String? = nil) async throws -> ZeroXQuoteResponse {
    ...
    do {
      ...
      return try await post(url, andPayload: body, mappingInResponse: ZeroXQuoteResponse.self)
    } catch {
  ...
  public func getPrice(request: ZeroXPriceRequest, zeroXApiKey: String? = nil) async throws -> ZeroXPriceResponse {
    ...
    do {
      ...
      return try await post(url, andPayload: body, mappingInResponse: ZeroXPriceResponse.self)
    } catch {
