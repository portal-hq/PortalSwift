...
class PortalMpcSpy: PortalMpcProtocol {
    ...
    func backup(method: PortalSwift.BackupMethods.RawValue, backupConfigs: PortalSwift.BackupConfigs?, completion: @escaping (PortalSwift.Result<String>) -> Void, progress: ((PortalSwift.MpcStatus) -> Void)?) {
    ...
    func generate(completion: @escaping (PortalSwift.Result<String>) -> Void, progress: ((PortalSwift.MpcStatus) -> Void)?) {
        generateWithCompletionCallsCount += 1
        generateWithCompletionProgressCallbackParam = progress
    }

    func ejectPrivateKey(clientBackupCiphertext: String, method: PortalSwift.BackupMethods.RawValue, backupConfigs: PortalSwift.BackupConfigs?, orgBackupShare: String, completion: @escaping (PortalSwift.Result<String>) -> Void) {
    ...
    func recover(cipherText: String, method: PortalSwift.BackupMethods.RawValue, backupConfigs: PortalSwift.BackupConfigs?, completion: @escaping (PortalSwift.Result<String>) -> Void, progress: ((PortalSwift.MpcStatus) -> Void)?) {
