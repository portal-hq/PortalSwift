...
public let mockClentId = "test-client-id"
...
public let mockClientResult = "{\"data\":{\"id\":\"\(mockClentId)\",\"address\":\"\(mockAddress)\",\"clientApiKey\":\"someApiKey\",\"custodian\":{\"id\":\"someCustodianId\",\"name\":\"someCustodianName\"}},\"error\":{\"code\":0,\"message\":\"\"}}"
