...
open class Storage {
  ...
  /// - Returns: Void
  open func delete(completion: @escaping (Result<Bool>) -> Void) -> Void {
  ...
  /// - Returns: Void
  open func read(completion: @escaping (Result<String>) -> Void) -> Void {
    completion(Result(error: StorageError.mustExtendStorageClass))
  }
  ...
  /// - Parameter completion: Resolves as a Result<Bool>.
  /// - Returns: Void
  open func write(privateKey: String, completion: @escaping (Result<Bool>) -> Void) -> Void {
    completion(Result(error: StorageError.mustExtendStorageClass))
  }
}
